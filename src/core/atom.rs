...
impl Element {
    ...
    /// All element variants (103 named elements + `Unknown`).
    pub fn all_variants() -> &'static [Element] {
        use Element::*;
        const VARIANTS: [Element; 104] = [
            ...
            Pa, U, Np, Pu, Am, Cm, Bk, Cf, Es, Fm, Md, No, Lr, Unknown,
        ];
        &VARIANTS
    }
}
